...
struct Sep6WithdrawalStepper: View {
    ...
    @StateObject private var viewModel: Sep6WithdrawalStepperViewModel
    ...
    internal init(anchoredAsset: AnchoredAssetInfo,
        ...
        self._viewModel = StateObject(wrappedValue: Sep6WithdrawalStepperViewModel(
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarLeading) {
                    Text("SEP-06 Withdrawal Stepper").font(.headline).frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .topLeading)
                }
