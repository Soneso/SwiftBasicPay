...
struct Sep6WithdrawalStepper: View {
    ...
    @State private var viewModel: Sep6WithdrawalStepperViewModel
    ...
    internal init(anchoredAsset: AnchoredAssetInfo,
        ...
        self._viewModel = State(wrappedValue: Sep6WithdrawalStepperViewModel(
    ...
    private var transferDetailsStep: some View {
        VStack(alignment: .leading, spacing: 20) {
            Text("Enter withdrawal details")
                .font(.title3)
                .fontWeight(.semibold)
            
            Text("Please provide the required information for your withdrawal")
                .font(.subheadline)
                .foregroundStyle(.secondary)
    ...
    private var feeStep: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Text("Review the fee for this withdrawal")
                .font(.subheadline)
                .foregroundStyle(.secondary)
    ...
    private var summaryStep: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            if viewModel.submissionResponse != nil {
                ...
                Text("Please review your withdrawal details before submitting")
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
            }
